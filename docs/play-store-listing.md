...
> **번호 이력 (확인한 값만).**
> - versionCode **9 (2.3.0)** — 프로덕션 라이브.
> - **10 (2.4.0)** — AAB 를 만든 적이 없다(Release AAB 실행 이력으로 확인). 스토어에 나간 적 없음.
> - **11 (2.5.0)** — Release AAB run #9(2026-09-06, 커밋 `9064f10`)가 빌드했고
>   Play Console 에 업로드됨. **11 은 이미 쓴 번호라 재사용할 수 없다.**
> - **12 (2.5.1)** — 이번 빌드.
>
