...
> | versionCode | 상태 |
> |---|---|
> | **14 (2.6.0)** | **프로덕션 게시됨** (2026-09-15 확인). Release AAB run #12(커밋 `ec0bb38`) 산출물. 팀 관리자 권한 + 위치 공개 수준(아래 출시 노트). 지금 사용자가 받는 버전. |
...
>
> 번호는 재사용할 수 없다. 14 가 게시됐으므로 다음은 15 다.
>
> 아래 노트로 14 가 게시됐다. 다음 릴리즈(15)의 노트는 **2.6.0 이후 변경분만**
> 담으면 된다.
