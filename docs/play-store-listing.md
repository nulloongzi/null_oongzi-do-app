...
> | versionCode | 상태 |
> |---|---|
> | **13 (2.5.2)** | **업로드 대기** — 이번 빌드. 2.5.1 이후 수정 2건(아래 출시 노트). |
> | 12 (2.5.1) | 2026-09-07 22:20 게시, 설치 18회(2026-09-08 확인). Release AAB run #10 산출물. 13 을 올리기 전까지 사용자가 받는 버전. |
...
>
> 번호는 재사용할 수 없다. 13 을 게시하고 나면 다음은 14 다.
>
> 2.5.1(12)이 실제로 게시돼 설치까지 됐으므로, 이번 출시 노트는 **2.5.1 이후
> 변경분만** 담는다. 2.3.0 에서 건너뛰는 사용자를 위해 통째로 나열하던 이전
> 노트는 아래 접힌 블록에 그대로 남겨둔다.
