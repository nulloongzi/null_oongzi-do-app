...
- [x] **Play 프로덕션 출시 완료** — `2.1.0+7`(versionCode 7) 활성, 설치 17회. 다음 업로드는 versionCode 8 이상.
...
- [x] **개인정보처리방침 갱신 완료** — 웹 레포 `privacy.html`(시행일 2026-07-28, 커밋 `2362796`)이
      소셜 로그인 수집 항목(카카오/네이버 회원번호, 구글 계정 이메일)과 처리위탁(Google Firebase)을
      반영한다. 빈 템플릿 `privacy.md`는 제거됨 → **Play Console에는 `privacy.html` URL을 넣을 것.**
